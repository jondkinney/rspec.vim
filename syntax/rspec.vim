...
syntax keyword rspecMatchers be change eql equal exist expect allow expect_any_instance_of allow_any_instance_of receive have have_at_least have_at_most have_exactly include match matcher raise_error raise_exception respond_to satisfy throw_symbol to to_not not_to when wrap_expectation
